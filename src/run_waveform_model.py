...
# Select records for training/testing across all 10 folds
records_to_download = []
for fold in range(1, 11):
    sub = clean_df[clean_df['strat_fold'] == fold]
    records_to_download.extend(sub['filename_lr'].tolist()[:150]) # 150 per fold = 1500 records

print('Downloading records from PhysioNet via WFDB...')
wfdb.dl_database('ptb-xl', dl_dir=DATA_DIR, records=records_to_download)
print('Records downloaded successfully!')
